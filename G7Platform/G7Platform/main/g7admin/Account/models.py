...
#必须
    ...
    userid = models.CharField(verbose_name=_(u"用户ID"),max_length=100,default="".join(str(uuid.uuid4()).split("-")),blank=True)
    ...
    usignature = models.CharField(verbose_name=_(u"用户登陆标识"),max_length=100,default="".join(str(uuid.uuid4()).split("-")), blank=True)
